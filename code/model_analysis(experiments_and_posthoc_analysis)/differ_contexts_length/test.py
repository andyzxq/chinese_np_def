...
def drawMarrix(y_true, y_pred, config):
    ...
    plt.savefig("./result/bert_b48dp01_ft_df_epoch3_n4.png")
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("./model/bert_b48dp01_ft_df_epoch3_n4.pt", map_location=torch.device("cuda:0")))
    ...
    results.to_csv("./result/df_bert_base_predict_n4.csv", header=["true", "predict"], index=False)
